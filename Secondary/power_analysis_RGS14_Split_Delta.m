...
%                         end
        ...
        ratiodelta_PT1_4=mean(ratiodelta_sec1);
        save(strcat('ratiodelta_PT1-4_',stage,'_',g{j},'_',barea),'ratiodelta_PT1_4')
        ...
        ratiodelta_PT5=mean(ratiodelta_sec2);
        save(strcat('ratiodelta_PT5_',stage,'_',g{j},'_',barea),'ratiodelta_PT5')
