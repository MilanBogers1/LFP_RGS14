function [swr_hpc,swr_pfc,s_hpc,s_pfc,V_hpc,V_pfc,signal2_hpc,signal2_pfc,sd_swr, M_multiplets, Mx_multiplets, multiplets,Mono_hpc,Mono_pfc]=swr_check_thr(HPC,PFC,states,ss,D1,D2)
...
[M_multiplets, Mx_multiplets, multiplets]=findmultiplets(Mx_hpc);
...
%D2=35;%THRESHOLD
    [Sx_pfc,Ex_pfc,Mx_pfc] =cellfun(@(equis1,equis2) findSlowOSLisa(equis1, equis2, D2, (D2)*(1/2), [] ), signal2_pfc,ti,'UniformOutput',false);    
