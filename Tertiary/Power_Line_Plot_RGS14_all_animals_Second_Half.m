...
subplot(4,2,1);
semilogy(x,mean_meanpower_Second_Half_CON1,x,mean_meanpower_Second_Half_OD1,x,mean_meanpower_Second_Half_OR1,x,mean_meanpower_Second_Half_HC1, 'LineWidth',2);
...
subplot(4,2,2);
semilogy(x,mean_meanpower_Second_Half_CON3,x,mean_meanpower_Second_Half_OD3,x,mean_meanpower_Second_Half_OR3,x,mean_meanpower_Second_Half_HC3, 'LineWidth',2);
legend('CON','OD','ÓR','HC','Location','northeast');
ylabel('Power');
xlabel('Frequency');
xlim([zz, freq]);
...
subplot(4,2,3);
semilogy(x,mean_meanpower_Second_Half_CON2,x,mean_meanpower_Second_Half_OD2,x,mean_meanpower_Second_Half_OR2,x,mean_meanpower_Second_Half_HC2, 'LineWidth',2);
legend('CON','OD','ÓR','HC','Location','northeast');
ylabel('Power');
xlabel('Frequency');
xlim([zz, freq]);
...
subplot(4,2,4);
semilogy(x,mean_meanpower_Second_Half_CON4,x,mean_meanpower_Second_Half_OD4,x,mean_meanpower_Second_Half_OR4,x,mean_meanpower_Second_Half_HC4, 'LineWidth',2);
legend('CON','OD','ÓR','HC','Location','northeast');
ylabel('Power');
xlabel('Frequency');
xlim([zz, freq]);
...
subplot(4,2,5);
semilogy(x,mean_meanpower_Second_Half_CON6,x,mean_meanpower_Second_Half_OD6,x,mean_meanpower_Second_Half_OR6,x,mean_meanpower_Second_Half_HC6, 'LineWidth',2);
legend('CON','OD','ÓR','HC','Location','northeast');
ylabel('Power');
xlabel('Frequency');
xlim([zz, freq]);
...
subplot(4,2,6);
semilogy(x,mean_meanpower_Second_Half_CON7,x,mean_meanpower_Second_Half_OD7,x,mean_meanpower_Second_Half_OR7,x,mean_meanpower_Second_Half_HC7, 'LineWidth',2);
legend('CON','OD','ÓR','HC','Location','northeast');
ylabel('Power');
xlabel('Frequency');
xlim([zz, freq]);
...
subplot(4,2,7);
semilogy(x,mean_meanpower_Second_Half_CON9,x,mean_meanpower_Second_Half_OD9,x,mean_meanpower_Second_Half_OR9,x,mean_meanpower_Second_Half_HC9, 'LineWidth',2);
legend('CON','OD','ÓR','HC','Location','northeast');
ylabel('Power');
xlabel('Frequency');
xlim([zz, freq]);
...
subplot(4,2,8);
semilogy(x,mean_meanpower_Second_Half_CON8,x,mean_meanpower_Second_Half_OD8,x,mean_meanpower_Second_Half_OR8,x,mean_meanpower_Second_Half_HC8, 'LineWidth',2);
legend('CON','OD','ÓR','HC','Location','northeast');
ylabel('Power');
xlabel('Frequency');
xlim([zz, freq]);
