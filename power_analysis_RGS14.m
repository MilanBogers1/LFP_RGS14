...
%                         end
        ...
        for q=1:size(pxx_total,2)
            pxx_sec=pxx_total(:,q);
            ratiotheta_sec(q)=sum(pxx_sec(indexOfMin1:indexOfMin2))/sum(pxx_sec(1:indexOfMin3));
        end
        ratiotheta_sd=mean(ratiotheta_sec);
        save(strcat('ratiotheta_SD_Total_',stage,'_',g{j},'_',barea),'ratiotheta_sd')
