...
GC_window_ripples = {};
    for c=1:size(ripples,1)
       ...
       GC_window_ripples{c,1} = [concatenated_NREM_pfc(int32(ripples(c,6)*1000+1-(3*1000)) : int32(ripples(c,6)*1000+1+(3*1000)))].';
       GC_window_ripples{c,1}(2,:) = concatenated_NREM_hpc(int32(ripples(c,6)*1000+1-(3*1000)) : int32(ripples(c,6)*1000+1+(3*1000)));
