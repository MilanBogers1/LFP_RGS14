clear variables
cd('I:\Milan_DA\RGS14_Ephys_da\Data_RGS14_Downsampled')
...
delta_waves={};
    for c=1:length(delta_total_data{j,1}{i,p})
        delta_waves{c,1}=[V_pfc{1,1}((delta_total_data{j,1}{i,p}(c,1)*1000):(delta_total_data{j,1}{i,p}(c,3)*1000),1)];
    end
    Delta_Waves_Total{j,1}{i,p}=delta_waves;
    end
...
total_delta_minute(j,i)=(total_delta(j,i)/stage_count*60);
delta_waves={};
    for c=1:size(delta_total_data{j,1}{i,p},1)
        delta_waves{c,1}=[V_pfc{1,1}((delta_total_data{j,1}{i,p}(c,1)*1000):(delta_total_data{j,1}{i,p}(c,3)*1000),1)];
    end
    Delta_Waves_Total{j,1}{i,p}=delta_waves;
    end
...
delta_waves={};
    for c=1:length(delta_total_data{j,1}{i+1,p})
        delta_waves{c,1}=[V_pfc{1,1}((delta_total_data{j,1}{i+1,p}(c,1)*1000):(delta_total_data{j,1}{i+1,p}(c,3)*1000),1)];
    end
    Delta_Waves_Total{j,1}{i+1,p}=delta_waves;
    end
...
delta_waves={};
    for c=1:length(delta_total_data{j,1}{i+2,p})
        delta_waves{c,1}=[V_pfc{1,1}((delta_total_data{j,1}{i+2,p}(c,1)*1000):(delta_total_data{j,1}{i+2,p}(c,3)*1000),1)];
    end
    Delta_Waves_Total{j,1}{i+2,p}=delta_waves;
    end
...
delta_waves={};
    for c=1:length(delta_total_data{j,1}{i+3,p})
        delta_waves{c,1}=[V_pfc{1,1}((delta_total_data{j,1}{i+3,p}(c,1)*1000):(delta_total_data{j,1}{i+3,p}(c,3)*1000),1)];
    end
    Delta_Waves_Total{j,1}{i+3,p}=delta_waves;
    end
...
save(strcat('Delta_Waves_Rat', rat_folder{k}), 'Delta_Waves_Total')
