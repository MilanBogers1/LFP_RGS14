...
%                         end
        ...
        ratiotheta_sd1=mean(ratiotheta_sec1);
        save(strcat('ratiotheta_SD_First_Half_Epoch',stage,'_',g{j},'_',barea),'ratiotheta_sd1')
        ...
        ratiotheta_sd2=mean(ratiotheta_sec2);
        save(strcat('ratiotheta_SD_Second_Half_Epoch',stage,'_',g{j},'_',barea),'ratiotheta_sd2')
