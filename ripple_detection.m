function [swr_hpc,swr_pfc,s_hpc,s_pfc,V_hpc,V_pfc,signal2_hpc,signal2_pfc,sd_swr, M_multiplets, Mx_multiplets, multiplets, ripples, Mono_hpc, Mono_pfc,total_swrs,total_NREM_min, S_r, M_r, E_r] = ripple_detection(HPC,Cortex,states,ss,offset1,offset2,TT,j,i) 
...
[swr_hpc,swr_pfc,s_hpc,s_pfc,V_hpc,V_pfc,signal2_hpc,signal2_pfc,sd_swr, M_multiplets, Mx_multiplets, multiplets, Mono_hpc,Mono_pfc] = swr_check_thr(HPC,Cortex,states,ss,D1,D2);
multiplet_count = {};

    continuous_timestamps = [(0:length(HPC)-1)/1000];
    e_t = 1;
